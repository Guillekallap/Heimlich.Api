        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalMeasurements = table.Column<int>(type: "int", nullable: false),
                    SuccessRate = table.Column<double>(type: "float", nullable: false),
                    AverageErrorsPerMeasurement = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxTimeInterval = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForceValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ForceStatus = table.Column<bool>(type: "bit", nullable: false),
                    TouchStatus = table.Column<bool>(type: "bit", nullable: false),
                    AngleDeg = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AngleStatus = table.Column<bool>(type: "bit", nullable: false),
