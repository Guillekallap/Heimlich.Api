...
namespace Heimlich.Infrastructure.Migrations
{
    ...
    partial class HeimlichDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Heimlich.Domain.Entities.Evaluation", b =>
                {
                    ...
                    b.Property<int>("TotalMeasurements")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Heimlich.Domain.Entities.EvaluationConfig", b =>
                {
                    ...
                    b.Property<int>("MaxTimeInterval")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Heimlich.Domain.Entities.Measurement", b =>
                {
                    ...
                    b.Property<string>("AngleDeg")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("AngleStatus")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ForceStatus")
                        .HasColumnType("bit");

                    b.Property<string>("ForceValue")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Heimlich.Domain.Entities.UserGroup", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Heimlich.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
